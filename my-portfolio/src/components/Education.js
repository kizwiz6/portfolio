...
import { longsandsGalleryImages, uniGalleryImages, acticheckGalleryImages, igo4GalleryImages } from '../galleryImages';
import AnimatedComponent from '../components/AnimatedComponent';
import Layout from '../components/Layout';

const Education = ({ education, activeTab, setActiveTab, setIsMenuOpen, isMenuOpen }) => {
    return (
